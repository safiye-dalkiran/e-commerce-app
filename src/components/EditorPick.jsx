...
function EditorPick() {
    return (
        <section className="bg-[#FAFAFA] py-20 px-6 lg:px-24">
            ...
            {/* Galeri Konteynırı */}
            <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto h-auto lg:h-[500px]">

                {/* MEN */}
                <div className="relative lg:flex-[2] group overflow-hidden h-[500px] lg:h-full">
                ...
                {/* WOMEN */}
                <div className="relative lg:flex-1 group overflow-hidden h-[500px] lg:h-full">
                ...
                {/* ACCESSORIES & KIDS - Mobilde de alt alta ama yükseklikleri dengeli */}
                <div className="flex flex-col gap-8 lg:flex-1">
                    {/* Accessories */}
                    <div className="relative h-[242px] lg:flex-1 group overflow-hidden">
